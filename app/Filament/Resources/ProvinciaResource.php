...
protected static ?string $modelLabel = 'Provincia';
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Select::make('region_id')
                ...
                ->relationship('region', 'region') // Relación con el modelo Region
                ->searchable()
                ->preload()
                ->required(),
        ]);
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            Tables\Columns\TextColumn::make('provincia')->label('Provincia')->searchable()->sortable(),
            Tables\Columns\TextColumn::make('region.region')->label('Región')->badge()->sortable(),
